...
<div style="float:left; width:100%; margin:50px 0; text-align:center;">
  <h1 style="font-size:36px; margin: 0;">
    <strong style="color: #f6087d; font-size: 50px; font-weight: 500;">CANCELLATION SUCCESSFUL</strong>
  </h1>
  <h1 style="margin: 0;">
    <strong style="color: #f6087d; font-size: 27px; font-weight: 500;">THANK YOU FOR USING OUR SERVICE!</strong>
  </h1>
  <p style="color:#171717; font-size:19px;">
    Please log in to your Business Academy<br>
